...
//             .checkPersonalInformation(userId: SecureVariables.userId as String);
//         await CheckMyRoleCubit.get(context).checkMyRole();
//         // Navigator will be triggered based on the BlocListener's response
//       },
//     ),
//     ListTileModel(
//       leading: Icons.message,
...
//               },
//             ),
//             BlocListener<CheckMyRoleCubit, CheckMyRoleState>(
//               listener: (context, state) async {
//                 if (state is IamATasker) {
//                   await GetTaskerByIdCubit.get(context).getTaskerById(
//                     taskerId: state.TaskerDataList[0].taskerId,
//                   );
//                 }
//                 Navigator.pushNamed(context, PersonalInformationScreen.id);
//               },
